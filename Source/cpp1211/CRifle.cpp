...
ACRifle::ACRifle()
{
	...
	CHelpers::GetClass<ACBullet>(&BulletClass, "Blueprint'/Game/BP_CBullet.BP_CBullet_C'"); // BP_C ∫Ÿ¿Ãº¿
...
void ACRifle::Firing()
{
	...
	{
		FRotator rotator = hitResult.ImpactNormal.Rotation(); // π›ªÁ∞¢ π˝º±∫§≈Õ
